...
export const MessageIcon = ({ className, width = '2.5rem', height = '2.5rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const BoxMessage = ({ className, width = '3.3rem', height = '3.3rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconSearch = ({ className, width = '2.6rem', height = '2.6rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
